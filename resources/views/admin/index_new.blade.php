            ...
            <div>
                ...
                <p class="fw-medium mb-0 text-muted">
                    ...
                    @if(auth()->user()->role === 'super_admin')
                        ...
                        Wallet Balance - <a class="fw-medium"
                            href="javascript:void(0)">&#8358;{{number_format($wallet[0]->total_balance, 2)}}</a>
                        <br>Withdrawable Balance - <a class="fw-medium"
                            href="javascript:void(0)">&#8358;{{number_format($wallet[0]->balance_gt_200, 2)}} </a>
                        <br> Dollar Wallet - <a class="fw-medium"
                            href="javascript:void(0)">${{number_format($wallet[0]->total_usd_balance, 2)}}</a>
                        <br> Total Payout - <a class="fw-medium"
                            href="javascript:void(0)">&#8358;{{ number_format($totalPayout, 2) }}</a>
                        ...
                        <br> Total Pending Payout - <a class="fw-medium"
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="block block-rounded text-center d-flex flex-column h-100 mb-0">
                    <div class="block-content block-content-full flex-grow-1">
                        ...
                        <div class="fs-1 fw-bold" data-toggle="tooltip" data-placement="top" title=""><span
                                id="campaigns"></span></div>
            ...
            function loadDashboardStats(period) {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        // Only update financial fields for super_admin
