  ...
  <div class="content">
    ...
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">USD Verified Users List - {{ $verifiedUsers->count() }}</h3>
          ...
          {{-- <table class="table table-bordered table-striped table-vcenter"> --}}
            ...
            <tbody>
                ...
                @foreach ($verifiedUsers as $user)
                    <tr>
                        <th scope="row">{{ $i++ }}.</th>
                        <td class="fw-semibold"><a href="{{ url('user/'.$user->user->id.'/info') }}" target="_blank"> {{$user->user->name }}</a></td>
