    ...
    <div class="content">
        <div class="block block-rounded">
            <div class="block-content text-center">
                <div class="py-4">
                    <div class="mb-3">
                        <img class="img-avatar img-avatar96" src="{{asset('src/assets/media/avatars/avatar15.jpg')}}"
                            alt="">
                    </div>
                    <h1 class="fs-lg mb-0">
                        {{$info->name}}
            ...
            <div class="block-content bg-body-light text-center">
                <div class="row items-push text-uppercase">
                    ...
                    <div class="col-6 col-md-3">
                        ...
                        <a class="link-fx fs-3" href="{{ url('admin/user/campaigns/' . $info->id) }}" target="_blank">
                            {{ $info->my_campaigns_count }} </a>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="fw-semibold text-dark mb-1">Jobs</div>
                        <a class="link-fx fs-3" href="{{ url('admin/user/jobs/' . $info->id) }}" target="_blank">
                            {{ $info->my_jobs_count }} </a>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="fw-semibold text-dark mb-1">Referral</div>
                        <a class="link-fx fs-3" href="{{ url('admin/user/referral/' . $info->id) }}"
                            target="_blank">{{ $info->referees_count }} </a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="block block-rounded block-bordered">
                            ...
                            <div class="block-content">
                                <address class="fs-sm">
                                    ...
                                    {{ @$info->profile->phone_verified == true ? 'Yes' : 'No' }}<br>
                                    &#8226; Email Verification:
                                    {{ @$info->email_verified_at == null ? 'Email Not Verified' : 'Email Verified' }}<br>
                        ...
                        <div class="block block-rounded block-bordered">
                            ...
                            <div class="block-content">
                                ...
                                <address class="fs-sm">
                                    ...
                                    @else
                                        <a href="{{ url('reactivate/virtual/account/' . $info->id) }}"
                                            class="btn btn-sm btn-success"> Generate Virtual Account </a>
                                        <br>
                                    @endif
                                </address>
        ...
        <div class="block block-rounded">
            <ul class="nav nav-tabs nav-tabs-block" role="tablist">
                ...
                <li class="nav-item">
                    <button class="nav-link active" id="search-photos-tab" data-bs-toggle="tab"
                        data-bs-target="#search-photos" role="tab" aria-controls="search-photos" aria-selected="false">
                        Credit Wallet
                    </button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" id="search-customers-tab" data-bs-toggle="tab"
                        data-bs-target="#search-customers" role="tab" aria-controls="search-customers"
                        aria-selected="false">
                        Verification
                    </button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" id="search-projects-tab" data-bs-toggle="tab" data-bs-target="#search-projects"
                        role="tab" aria-controls="search-projects" aria-selected="false">
                        Update Bank
                    </button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" id="search-project-tab-manage" data-bs-toggle="tab"
                        data-bs-target="#search-project-manage" role="tab" aria-controls="search-project-manage"
                        aria-selected="false">
                        Update Currency
                    </button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" id="search-business-tab" data-bs-toggle="tab" data-bs-target="#search-business"
                        role="tab" aria-controls="search-business" aria-selected="false">
                        Business Account
                    </button>
                </li>
            ...
            <div class="block-content tab-content overflow-hidden">
                ...
                <!-- Photos -->
                <div class="tab-pane fade show active" id="search-photos" role="tabpanel"
                            ...
                            <div class="form-row align-items-center">
                                <div class="col-auto">
                                    ...
                                    <div class=" mb-2">
                                        ...
                                        <input type="text" class="form-control" name="reason" placeholder="Provide reason"
                                            required>
                                    </div>
                                </div>
                ...
                <div class="tab-pane fade" id="search-customers" role="tabpanel" aria-labelledby="search-customers-tab">
                    ...
                    <div class="container">
                        ...
                        @if(baseCurrency($info) == 'NGN')
                            <center>
                                @if($info->is_verified == '0')

                                    <a class="btn btn-hero btn-primary mb-4" href="{{url('admin/upgrade/' . $info->id . '/naira')}}"
                                        data-toggle="click-ripple">
                                        Verify User (Naira) Now!
                                    </a>
                                @else
                                    <a class="btn btn-hero btn-warning mb-4" href="{{url('admin/upgrade/' . $info->id . '/naira')}}"
                                        data-toggle="click-ripple">
                        ...
                        @else
                            ...
                            <center>
                                @if(!$info->USD_verified)
                                    ...
                                    <a class="btn btn-hero btn-primary mb-4"
                                        href="{{url('admin/upgrade/' . $info->id . '/dollar')}}" data-toggle="click-ripple">
                                        Verify User ({{baseCurrency($info)}}) Now!
                                    </a>
                                @else
                                    <a class="btn btn-hero btn-warning mb-4"
                                        href="{{url('admin/upgrade/' . $info->id . '/dollar')}}" data-toggle="click-ripple">
                                        UnVerify User ({{ baseCurrency($info) }}) Now!
                                    </a>
                        ...
                        @if($info->wallet->base_currency == 'NGN')
                            ...
                            <center>
                                <a href="{{ url('reactivate/virtual/account/' . $info->id) }}"
                                    class="btn btn-hero btn-success mb-4">Activate VA</a>
                            </center>
                        @endif
                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="reminder-credential" name="account_number"
                ...
                <!-- Manage -->
                <div class="tab-pane fade" id="search-project-manage" role="tabpanel"
                    aria-labelledby="search-project-tab-manage">
                    ...
                    <div class="container">
                        ...
                        <form action="{{ url('admin/switch/wallet') }}" method="POST">
                            ...
                            <button class="btn btn-primary btn-sm" type="submit"><i
                                    class="fa fa-fw fa-share opacity-50"></i>Switch Currency</button>
                        ...
                        <hr>
                        <h4 class="fw-normal text-muted text-center">
                            Turn a User to Celebrity account. (They will not benefit from referral bonuses and there will bw
                            a 10% discount on verification)
                        </h4>
                        ...
                        @if($info->is_blacklisted == '0')
                            <center>
                                <a class="btn btn-hero btn-secondary mb-3" href="{{url('admin/blacklist/' . $info->id)}}"
                                    data-toggle="click-ripple">
                                    Blacklist User
                                </a>
                            </center>
                ...
                <!-- Add this tab pane after the "Update Currency" tab (around line 380) -->
                <div class="tab-pane fade" id="search-business" role="tabpanel" aria-labelledby="search-business-tab">
                    ...
                    <div class="container">
                        <div class="alert alert-info mb-4">
                            ...
                            <strong>Business Account Restrictions:</strong>
                            <ul class="mb-0 mt-2">
                                <li>Cannot withdraw funds</li>
                                <li>Cannot perform tasks/jobs</li>
                            </ul>
                        </div>
                        ...
                        <h5 class="fw-normal text-muted text-center mt-4 mb-4">
                            Toggle Business Account Status
                        </h5>

                        <form action="{{ route('admin.toggle.business') }}" method="POST" class="text-center">
                            @csrf
                            <input type="hidden" name="user_id" value="{{ $info->id }}">

                            @if($info->is_business)
                                <button type="submit" class="btn btn-warning btn-lg">
                                    <i class="fa fa-times-circle me-2"></i> Deactivate Business Account
                                </button>
                                <p class="text-muted mt-3 mb-0">
                                    <small>Click to convert back to regular account</small>
                                </p>
                            @else
                                <button type="submit" class="btn btn-success btn-lg">
                                    <i class="fa fa-check-circle me-2"></i> Activate Business Account
                                </button>
                                <p class="text-muted mt-3 mb-0">
                                    <small>Click to convert to business account</small>
                                </p>
                            @endif
                        </form>
