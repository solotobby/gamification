  ...
  <div class="bg-body-light">
    <div class="content content-full">
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
        <div>
          <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-1">User Transactions</h1>
          <span class="text-muted fs-sm">Comprehensive ledger of all user wallet debits, credits, and conversions</span>
        </div>
          ...
          <div class="col-xl-3 col-md-4 col-sm-6">
            <div class="currency-stat-card">
              <div class="stat-header">
                <span class="stat-title">{{ $currCode }} Volume</span>
              ...
              <div class="stat-footer d-flex justify-content-between align-items-center">
                <span>{{ number_format($tot->count) }} Transactions</span>
            ...
            <div class="col-md-6 col-lg-5">
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="search"
                       placeholder="Search reference, description, user name or email..."
    ...
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">
          Transaction Records <span class="badge bg-primary rounded-pill ms-2">{{ number_format($lists->total()) }}</span>
        </h3>
      </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="fw-semibold text-dark">
                      <a href="{{ url('user/'.@$list->user->id.'/info') }}" target="_blank" class="text-dark text-hover-primary">
                  ...
                  <td>
                    <div class="fs-sm text-muted text-truncate" style="max-width: 250px;" title="{{ $list->description }}">
                      {{ $list->description }}
                    </div>
                  </td>
                  <td>
              ...
              @empty
                <tr>
                  <td colspan="9" class="text-center py-5 text-muted">
                    ...
                    No user transactions match the selected filters.
                  </td>
                </tr>
              @endforelse
            </tbody>
