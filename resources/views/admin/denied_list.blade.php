...
@section('title', 'Denied Campaigns')
...
@section('content')
  ...
  <div class="bg-body-light">
    <div class="content content-full">
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
        <div>
          <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-1">Declined Campaigns</h1>
          <span class="text-muted fs-sm">Campaigns rejected by administrators during compliance review</span>
        </div>
  ...
  <div class="content">
    ...
    <!-- Denied Campaigns Table Card -->
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">
          Declined Submissions <span class="badge bg-danger rounded-pill ms-2">{{ number_format($campaigns->total()) }}</span>
        </h3>
      </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="fw-semibold text-dark">
                      <a href="{{ url('campaign/info/'.$camp->id) }}" class="text-dark text-hover-primary" target="_blank">
                        {{ $camp->post_title }}
                      </a>
                    </div>
                  ...
                  <td class="text-center">
                    <a href="{{ url('campaign/info/'.$camp->id) }}" class="btn btn-sm btn-outline-primary" target="_blank">
                      Inspect
                    </a>
                  </td>
                </tr>
              @empty
                <tr>
                  <td colspan="9" class="text-center py-5 text-muted">
                    <i class="fa fa-times-circle fa-3x text-muted mb-3 d-block opacity-25"></i>
                    No declined campaigns found matching the selected filters.
                  </td>
                </tr>
              @endforelse
            </tbody>
