                            ...
                            <tbody>
                                ...
                                @foreach ($campaigns as $camp)
                                    <tr>
                                        ...
                                        <td class="fw-semibold"><a href="{{ url('user/' . $camp->user->id . '/info') }}"
                                                target="_blank"> {{$camp->user->name }}</a> </td>
                                        ...
                                        <td>
                                            ...
                                            {{-- <button type="button" class="btn btn-alt-primary btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#modal-default-popout-{{ $camp->id }}">View</button> --}}
                                        </td>
                                    </tr>

                                    {{-- <div class="modal fade" id="modal-default-popout-{{ $camp->id }}" tabindex="-1"
                                                        ...
                                                        <div class="block block-rounded">
                                                            ...
                                                            <ul class="list-group push">
                                                                <li
                                                                    ...
                                                                    Url:
                                                                    <span class="badge rounded-pill bg-info"><a
                                                                            href="{{$camp->post_link}}"
                                                                            target="_blank">{{$camp->post_link}}</a></span>
                                                                </li>
                                                                <li
                                                                    class="list-group-item d-flex justify-content-between align-items-center">
                                                                    Category
                                                            ...
                                                            <form action="{{ route('campaign.status') }}" method="POST">
                                                                ...
                                                                <div class="mb-4 mt-4">
                                                                    <button type="submit" class="btn btn-alt-primary"
                                                                        name="status" value="Live"><i class="fa fa-check"></i>
                                                                        Approve</button>
                                                                    <button type="submit" class="btn btn-alt-danger"
                                                                        name="status" value="Decline"><i
