  ...
  <div class="bg-body-light">
    <div class="content content-full">
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
        <div>
          <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-1">Pending Campaigns Review</h1>
          <span class="text-muted fs-sm">Review, approve, or decline new campaigns submitted by users</span>
        </div>
          ...
          <table class="table table-modern table-hover align-middle mb-0">
            <thead>
              <tr>
                ...
                <th class="text-end">Total Escrow</th>
                <th>Status</th>
            ...
            <tbody>
              @forelse ($campaigns as $camp)
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <div class="btn-group">
                      <a href="{{ url('campaign/info/'.$camp->id) }}" class="btn btn-sm btn-primary">
                        <i class="fa fa-eye me-1"></i> Inspect & Approve
                      </a>
                    </div>
                  </td>
                </tr>
              @empty
                <tr>
                  <td colspan="9" class="text-center py-5 text-muted">
                    ...
                    All caught up! No campaigns currently pending review.
                  </td>
                </tr>
              @endforelse
            </tbody>
