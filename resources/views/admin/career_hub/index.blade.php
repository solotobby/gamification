    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Job Vacancy Management</h1>
                <nav class="flex-shrink-0 my-2 my-sm-0 ms-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Job Vacancies</li>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm" role="group">
                                            @if(!$job->trashed())
                                                <a href="{{ route('admin.career-hub.edit', $job) }}" class="btn btn-sm btn-alt-info"
                                                    title="Edit">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                                <a href="{{ route('admin.career-hub.applications', $job) }}"
                                                    class="btn btn-sm btn-alt-success" title="Applications">
                                                    <i class="fa fa-users"></i>
                                                </a>
                                                <form method="POST" action="{{ route('admin.career-hub.destroy', $job) }}"
                                                    class="d-inline" onsubmit="return confirm('Delete this job?')">
                                                    @csrf
                                                    @method('DELETE')
                                                ...
                                                <a href="{{ route('admin.career-hub.show', $job) }}"
