...
@section('content')
                ...
                <div class="block-content block-content-full">
                    <div class="row">
                        ...
                        <select class="form-select @error('tier') is-invalid @enderror" name="tier" required>
                            ...
                            <option value="sponsored" {{ old('tier' ?? '') == 'sponsored' ? 'selected' : '' }}>
                                Sponsored</option>
                        </select>
                        ...
                        <div class="col-md-6 mb-4">
                            <label class="form-label">Location <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('location') is-invalid @enderror"
                                    name="location" value="{{ old('location') }}"        placeholder="e.g. Lagos, Nigeria"
                                    required>
                                @error('location')
                    ...
                    <div class="col-md-2 mb-4">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="remote_allowed" id="remote_allowed"
                                value="1" {{ old('remote_allowed') ? 'checked' : '' }}>
    ...
    <div class="col-md-12 mb-4">
        <label class="form-label">Application Link</label>
            <input type="url" class="form-control @error('application_link') is-invalid @enderror" name="application_link"
    ...
    <div class="block block-rounded">
        ...
        <div class="block-content block-content-full">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <label class="form-label">Minimum Salary</label> <input type="number"
                            class="form-control @error('salary_min') is-invalid @enderror"        name="salary_min"
                            value="{{ old('salary_min') }}" step="0.01" placeholder="50000">
                        @error('salary_min')
                                        <div class="invalid-feedback">{{ $message }}
                            </div>
                        @enderror
            ...
            <div class="col-md-4 mb-4">
                <label class="form-label">Maximum Salary</label> <input type="number"
                        class="form-control @error('salary_max') is-invalid @enderror"        name="salary_max"
                        value="{{ old('salary_max') }}" step="0.01" placeholder="100000">
                    @error('salary_max')
                                    <div class="invalid-feedback">{{ $message }}
                        </div>
                    @enderror
    ...
    <div class="block block-rounded">
        ...
        <div class="block-content block-content-full">
            ...
            <div class="col-md-6 mb-4">
                <label class="form-label">Company Logo</label> <input type="file"
