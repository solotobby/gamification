            ...
            <div class="block block-rounded">
                <div class="block-content block-content-full">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $job->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 mb-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="remote_allowed" id="remote_allowed"
                                    value="1" {{ old('remote_allowed', $job->remote_allowed) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <input type="url" class="form-control @error('application_link') is-invalid @enderror"
                                name="application_link" value="{{ old('application_link', $job->application_link ?? '') }}"
