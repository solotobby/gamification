        ...
        <tbody>
            <tr>
                <td style="padding: 30px 30px 15px 30px;">
                    <h2 style="font-size: 18px; color: #6576ff; font-weight: 600; margin: 0;">Job Submitted Successfully
                    </h2>
                </td>
            </tr>
            <tr>
                <td style="padding: 30px 30px 20px">
                    ...
                    <p style="margin-bottom: 10px;">
                        Thank you for completing <b>{{$campaign_name}}</b> at <b>&#8358;{{ $amount }}</b>, your job has been
