            ...
            <tr>
                <td style="padding:40px 30px;">
                    ...
                    <p style="margin:0 0 15px 0;">
                        You now have access to thousands of simple tasks that can earn you money daily plus EXTRA 50k to
                        your
                        account every week.
                    </p>
                    ...
                    <ul style="margin:0 0 20px 0;padding-left:20px;">
                        <li style="margin:0 0 8px 0;"><strong>Micro Tasks:</strong> Complete easy tasks and withdraw
                            earnings in your local currency every
                            Friday.</li>
                        <li style="margin:0 0 8px 0;"><strong>Full-time Jobs:</strong> Apply for 9am–5pm jobs or recruit
                            full-time staff for your projects.
                        </li>
                        <li style="margin:0 0 8px 0;"><strong>Affiliate Marketing:</strong> Earn ₦1000 for every verified
                            user you refer. Many of our users
                            have made millions simply by sharing their referral link or creating short videos about Freebyz.
                        </li>
                        <li style="margin:0 0 8px 0;"><strong>Global Reach:</strong> Over 330,000 users worldwide trust
                            Freebyz.</li>
                    </ul>
                    ...
                    <p style="margin:0 0 15px 0;">
                        To start, <a href="{{ url('/login') }}">Login</a> now to Copy your referral link now and start
                        sharing with
                        your friends on Whatsapp, Facebook or TikTok and encourage them to verify their account with just
                        3000
                        naira.
                    ...
                    <p style="margin:0 0 15px 0;">
                        <a href="https://www.tiktok.com/@freebyzjobs/video/7449104740341779717">Click here</a> to see others
                        earning
                        big on Freebyz. We can't wait to start crediting your account too.
                    </p>

                    <p style="margin:0 0 20px 0;">Follow our official updates <a
                            href="https://facebook.com/remotejobsbyfreebyz">here</a></p>
