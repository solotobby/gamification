...
<div class="bg-body-light">
    <div class="content content-full">
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
        <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Error</h1>
        <nav class="flex-shrink-0 my-2 my-sm-0 ms-sm-3" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item">Error</li>
            <li class="breadcrumb-item active" aria-current="page">Payment Unsuccessful</li>
          </ol>
        </nav>
      </div>
    </div>
        ...
        <div class="block block-rounded invisible" data-toggle="appear">
          <div class="block-content block-content-full">
            <div class="py-5 text-center">
              ...
              <div class="fs-4 fw-semibold pt-3 mb-0">Payment Unsuccessful</div>
            </div>
          </div>
        </div>
      </div>
