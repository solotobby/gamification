 ...
 <div class="bg-image" style="background-image: url('{{ asset('src/assets/media/photos/photo11@2x.jpg') }}');">
    <div class="bg-black-75">
      <div class="content content-boxed text-center">
        <div class="py-5">
          <h1 class="fs-2 fw-normal text-white">
          ...
          <div class="row py-3">
            <div class="col-sm-12 col-md-12 mb-5">
              ...
              <p class="mb-0 text-muted">
                ...
                <br>
                To get started, reach out to your friends and family members to share the advantages of health insurance and the healthcare plans available (<a href="#link"> see your unique link below</a>).
              </p>
            </div>
            <div class="col-sm-12 col-md-12 mb-5">
              <div class="my-3">
              ...
              <p class="mb-0 text-muted">
                Wellahealth care is currently accessible in Nigeria however as a Freebyz user outside Nigeria, you can share your Wellahealth (<a href="#link">link below</a>) with your friends in Nigeria so that you’ll earn up to 7% when they pay for the healthcare plan.
              </p>
            </div>
      ...
      <div class="content content-boxed text-center">
        <div class="py-5">
          ...
          <h3 class="h4 fw-light text-muted push text-center">
            Send the link below to your family and friends to buy Health Insurance powered by WellaHealth and Freebyz
          </h3>
