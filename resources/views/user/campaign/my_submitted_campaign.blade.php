            ...
            <div class="block-content block-content-full">
                <div class="d-sm-flex">
                    <div class="ms-sm-2 me-sm-4 py-2">
                        <a class="item item-rounded bg-body-dark text-dark fs-4 mb-2 mx-auto"
                            href="{{ url('campaign/' . $work->campaign->job_id) }}">
                    ...
                    <div class="py-2">
                        ...
                        <div class="fs-sm fw-semibold text-muted mb-2">
                            Completed - {{ $work->campaign->completed()->where('status', 'Approved')->count() }} of
                            {{ $work->campaign->number_of_staff }}
                        </div>
