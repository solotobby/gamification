 ...
 <div class="bg-image" style="background-image: ('src/assets/media/photos/photo21@2x.jpg')">
  ...
  <div class="content content-boxed">
    ...
    <h2 class="content-heading">
      <i class="fa fa-plus text-success me-1"></i> Edit Campaign
    </h2>
    @if (session('success'))
        ...
        <div class="block-content block-content-full">
          ...
          <div class="row items-push">
            ...
            <div class="col-lg-6 offset-lg-1">
              ...
              <div class="mb-4">
                <label class="form-label" for="post-category">Category</label> : <i>{{ $campaign->campaignCategory->name }}</i>
                {{-- <select class="js-select2 form-select" id="post-category" name="campaign_subcategory" style="width: 100%;" data-placeholder="Choose category.." required>
                    <option value="{{ $campaign->campaignCategory->id }}">{{ $campaign->campaignCategory->name }}</option>
                </select> --}}
              </div>
