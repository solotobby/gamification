                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="skill_category_id" class="form-control" id="skill_set" required> 
                        ...
                        <div class="mb-4">
                            ...
                            <select name="skill_sub_category_id" class="form-control" id="skill_set_sub_categories" required> 
                      ...
                      <div class="mb-4">
                        ...
                        <!-- SimpleMDE Container -->
                        <textarea class="js-simplemde" id="simplemde" name="work_experience">Enter Your work and business experience</textarea>
                      </div>
